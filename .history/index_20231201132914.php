                                        ...
                                        <div class="displayForm">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="m-3">
                                                    ...
                                                    <input type="tel" class="form-control <?php echo isset($formError['firstname']) ? 'invalid-input' : ''; ?>" value="" name="phone" id="phone" aria-describedby="Numéro de téléphone">
                                                </div>
                                            </div>
                                            <div>
                                                <div class="m-3">
                                                    <label for="email" class="form-label ">E-mail<span>*</span></label>
                                                    <input type="email" class="form-control <?php echo isset($formError['firstname']) ? 'invalid-input' : ''; ?>" name="email" value="" id="email" aria-describedby="email">
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                                <div class="m-3">
                                                    <label for="surface" class="form-label">Surface (en m2)<span>*</span></label>
                                                    <input type="number" min="0" class="form-control <?php echo isset($formError['firstname']) ? 'invalid-input' : ''; ?>" name="surface" value="" id="surface" aria-describedby="Surface (en m2)">
                                                </div>

                                                <div class="m-3">
                                                    <label for="frequency" class="form-label ">Fréquence<span>*</span></label>
                                                    <select type="text" class="form-control <?php echo isset($formError['firstname']) ? 'invalid-input' : ''; ?>" name="frequency" value="" id="frequency" aria-describedby="telephone">
                                            ...
                                            <div>
                                                <div class="m-3">
                                                    ...
                                                    <input type="text" class="form-control <?php echo isset($formError['firstname']) ? 'invalid-input' : ''; ?>" name="city" value="" id="city" aria-describedby="Ville">
                                                </div>
                                            </div>
                                            <div class="form-floating m-3">
                                                <textarea class="form-control <?php echo isset($formError['firstname']) ? 'invalid-input' : ''; ?>" placeholder="Leave a comment here" id="message" style="height: 100px" name="message" value=""></textarea>
