                                        ...
                                        <div class="displayForm">
                                            <div class="d-flex">
                                                <div class="m-3">
                                                    ...
                                                    <input type="text" class="form-control" value="" id="firstname"  name="firstname" aria-describedby="Prénom">
                                                </div>
                                                <div class="m-3">
                                                    <label for="lastname" class="form-label">Nom<span>*</span></label>
                                                    <input type="text" class="form-control  <?php echo isset($formError['firstname']) ? 'invalid-input' : ''; ?>" value="" id="lastname" name="lastname" aria-describedby="Nom">
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                                <div class="m-3">
                                                    <label for="companyName" class="form-label">Nom de l'entreprise<span>*</span></label>
                                                    <input type="text" class="form-control  <?php echo isset($formError['firstname']) ? 'invalid-input' : ''; ?>" value="" name="companyName" id="companyName" aria-describedby="Nom de l'entreprise">
                                                </div>
                                                <div class="m-3">
                                                    <label for="phone" class="form-label ">Numéro de téléphone<span>*</span></label>
                                                    <input type="tel" class="form-control" value="" name="phone" id="phone" aria-describedby="Numéro de téléphone">
                                                </div>
                                            </div>
                                            <div>
                                                <div class="m-3">
                                                    <label for="email" class="form-label ">E-mail<span>*</span></label>
                                                    <input type="email" class="form-control" name="email" value="" id="email" aria-describedby="email">
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                                <div class="m-3">
                                                    <label for="surface" class="form-label">Surface (en m2)<span>*</span></label>
                                                    <input type="number" min="0" class="form-control" name="surface" value="" id="surface" aria-describedby="Surface (en m2)">
                                                </div>

                                                <div class="m-3">
                                                    <label for="frequency" class="form-label ">Fréquence<span>*</span></label>
                                                    <select type="text" class="form-control" name="frequency" value="" id="frequency" aria-describedby="telephone">
                                            ...
                                            <div>
                                                <div class="m-3">
                                                    ...
                                                    <input type="text" class="form-control" name="city" value="" id="city" aria-describedby="Ville">
                                                </div>
                                            </div>
                                            <div class="form-floating m-3">
                                                <textarea class="form-control" placeholder="Leave a comment here" id="message" style="height: 100px" name="message" value=""></textarea>
                                                <label for="message">Votre message (optionnel)</label>
                                            </div>
                                            <div class="form-check m-3">
                                                <input class="form-check-input" type="checkbox" name="flexCheck" value="" id="flexCheck">
