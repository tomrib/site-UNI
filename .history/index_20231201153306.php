                                        ...
                                        <div class="displayForm">
                                            ...
                                            <div>
                                                <div class="m-3">
                                                    ...
                                                    <input type="text" class="form-control <?php echo isset($formError['city']) ? 'invalid-input' : ''; ?>" name="city" value="<?php echo isset($formError['city']) ? $formError['city'] : ''; ?>" id="city" aria-describedby="Ville">
                                                </div>
                                            </div>
