                                        ...
                                        <div class="displayForm">
                                            <div class="d-flex">
                                                <div class="m-3">
                                                    ...
                                                    <input type="text" class="form-control" id="firstname" aria-describedby="Prénom">
                                                </div>
                                                <div class="m-3">
                                                    <label for="exampleInputPassword1" class="form-label">Nom<span>*</span></label>
                                                    <input type="text" class="form-control" id="exampleInputPassword1" aria-describedby="Nom">
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                                <div class="m-3">
                                                    <label for="exampleInputPassword1" class="form-label">Nom de l'entreprise<span>*</span></label>
                                                    <input type="text" class="form-control" id="Nom de l'entreprise">
                                                </div>
                                                <div class="m-3">
                                                    <label for="tel" class="form-label ">Numéro de téléphone<span>*</span></label>
                                                    <input type="tel" class="form-control" id="tel" aria-describedby="telephone">
                                                </div>
                                            </div>
                                            <div>
                                                <div class="m-3">
                                                    <label for="mail" class="form-label ">E-mail<span>*</span></label>
                                                    <input type="email" class="form-control" id="mail" aria-describedby="E-mail">
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                                <div class="m-3">
                                                    <label for="exampleInputPassword1" class="form-label">Surface (en m2)<span>*</span></label>
                                                    <input type="text" class="form-control" id="Nom de l'entreprise">
                                                </div>

                                                <div class="m-3">
                                                    <label for="tel" class="form-label ">Fréquence<span>*</span></label>
                                                    <select type="tel" class="form-control" id="tel" aria-describedby="telephone">
                                                        ...
                                                        <option value="3 fois par semaine"></option>
                                                        <option value="4 fois par semaine"></option>
                                                        <option value="5 fois par semaine"></option>
                                                        <option value="6 fois par semaine"></option>
                                                        <option value="7 fois par semaine"></option>
                                                        <option value="Mensuelle"></option>
                                                        <option value="Occasionnelle"></option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div>
                                                <div class="m-3">
                                                    <label for="mail" class="form-label ">Ville<span>*</span></label>
                                                    <input type="email" class="form-control" id="mail" aria-describedby="E-mail">
                                                </div>
                                            </div>
                                            <div class="form-floating m-3">
                                                <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"></textarea>
                                                <label for="floatingTextarea2">Votre message (optionnel)</label>
                                            </div>
