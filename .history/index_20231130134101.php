                ...
                <div class="col">
                    ...
                    <section class="d-flex">
                        <div id="cardContainer" class="cardContainer">
                            <div class="cardSide">
                                <div class="side cardFront">
                                    <img src="assets\img\menage_bureau.jpg" alt="Après">
                                </div>
                                <div class="side cardBack">
                                    <img src="assets\img\entretion_bureau.jpg" alt="Avant">
                                </div>
                            </div>
                        </div>
                        <div id="cardContainer" class="cardContainer">
                        ...
                        <div id="cardContainer" class="cardContainer">
                            <div class="cardSide">
                                <div class="side cardFront">
                                    <img class="side" src="assets\img\menage_bureau.jpg" alt="Après">
                                </div>
                                <div class="side cardBack">
                                    <img src="assets\img\entretion_bureau.jpg" alt="Avant">
                                </div>
