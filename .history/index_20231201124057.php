                                        ...
                                        <div class="displayForm">
                                            ...
                                            <div class="d-flex">
                                                <div class="m-3">
                                                    ...
                                                    <input type="text" class="form-control" id="companyName" aria-describedby="Nom de l'entreprise">
                                                </div>
                                                <div class="m-3">
                                                    <label for="phone" class="form-label ">Numéro de téléphone<span>*</span></label>
                                                    <input type="tel" class="form-control" id="phone" aria-describedby="telephone">
                                                </div>
                                            </div>
                                            <div>
                                                <div class="m-3">
                                                    <label for="email" class="form-label ">E-mail<span>*</span></label>
                                                    <input type="email" class="form-control" id="email" aria-describedby="E-mail">
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                                <div class="m-3">
