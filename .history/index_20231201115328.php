                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="m-3">
                                                    ...
                                                    <select type="tel" class="form-control" id="tel" aria-describedby="telephone">
                                                        <option value="">En soumettant ce formulaire, j'accepte que les informations saisies soient exploitées dans le cadre de la demande de devis et de la relation commerciale qui peut en découler.*</option>
                                                        <option value=""></option>
                                                        <option value=""></option>
                                                        <option value=""></option>
                                                        <option value=""></option>
