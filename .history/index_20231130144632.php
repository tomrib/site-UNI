        ...
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">Barre de navigation</font>
                </font>
            </a>
                ...
                <section>
                    <div class="text-center m-5">
                        <div class="d-flex">
                            ...
                            <img class="col ms-5 img
business" src="assets/img/van.jpg" alt="camionnette de couleur blanc avec le logo de l'entreprice">
                        </div>
                    </div>
                </section>
                <section>
