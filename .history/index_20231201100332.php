...
<body>
    ...
    <div class="container-fluid">
        <section>
            <div class="headImg">
                <div>
                    <img class="head" src="assets/img/logo/logo_uni_512x512_transparent.png" alt="Le logo est un triangle de couleur verte, et au centre, il y a un balai de couleur vert pâle qui laisse des traces de propreté.">
